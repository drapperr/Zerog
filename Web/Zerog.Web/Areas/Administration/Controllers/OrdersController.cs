...
namespace Zerog.Web.Areas.Administration.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Total,OrderStatus,PaymentMethod,IsDeleted,DeletedOn,Id,CreatedOn,ModifiedOn")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Total,OrderStatus,PaymentMethod,IsDeleted,DeletedOn,Id,CreatedOn,ModifiedOn")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
