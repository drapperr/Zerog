        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpticalDevice = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    Demensions = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Laptops_Audios_AudioId",
                        column: x => x.AudioId,
                        principalTable: "Audios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Laptops_Batteries_BatteryId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Laptops_HDDs_HDDId",
                        column: x => x.HDDId,
                        principalTable: "HDDs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Laptops_Lan_LanId",
                        column: x => x.LanId,
                        principalTable: "Lan",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Laptops_Memories_MemoryId",
                        column: x => x.MemoryId,
                        principalTable: "Memories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Laptops_OperatingSystems_OperatingSystemId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Laptops_Purposes_PurposeId",
                        column: x => x.PurposeId,
                        principalTable: "Purposes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Laptops_SSDs_SSDId",
                        column: x => x.SSDId,
                        principalTable: "SSDs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraLaptop", x => new { x.ExtrasId, x.LaptopsId });
                    table.ForeignKey(
                        name: "FK_ExtraLaptop_Extras_ExtrasId",
                        column: x => x.ExtrasId,
                        principalTable: "Extras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExtraLaptop_Laptops_LaptopsId",
            ...
            migrationBuilder.CreateTable(
                name: "KeyboardDetailLaptop",
                columns: table => new
                {
                    KeyboardDetailsId = table.Column<int>(type: "int", nullable: false),
                    LaptopsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeyboardDetailLaptop", x => new { x.KeyboardDetailsId, x.LaptopsId });
                    table.ForeignKey(
                        name: "FK_KeyboardDetailLaptop_KeyboardDetails_KeyboardDetailsId",
                        column: x => x.KeyboardDetailsId,
                        principalTable: "KeyboardDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_KeyboardDetailLaptop_Laptops_LaptopsId",
                        column: x => x.LaptopsId,
                        principalTable: "Laptops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LaptopPort", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LaptopPort_Ports_PortId",
                        column: x => x.PortId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Displays_IsDeleted",
                table: "Displays",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraLaptop_LaptopsId",
                table: "ExtraLaptop",
                column: "LaptopsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeyboardDetailLaptop_LaptopsId",
                table: "KeyboardDetailLaptop",
                column: "LaptopsId");

            migrationBuilder.CreateIndex(
                name: "IX_KeyboardDetails_IsDeleted",
                table: "KeyboardDetails",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Lan_IsDeleted",
                table: "Lan",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_LaptopPort_LaptopId",
                table: "LaptopPort",
                column: "LaptopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Laptops_AudioId",
                table: "Laptops",
                column: "AudioId");

            migrationBuilder.CreateIndex(
                name: "IX_Laptops_BatteryId",
                table: "Laptops",
                column: "BatteryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Laptops_OperatingSystemId",
                table: "Laptops",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Laptops_PurposeId",
                table: "Laptops",
                column: "PurposeId");

            migrationBuilder.CreateIndex(
                name: "IX_Laptops_SSDId",
                table: "Laptops",
                column: "SSDId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperatingSystems_IsDeleted",
